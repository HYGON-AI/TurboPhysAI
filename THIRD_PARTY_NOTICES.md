...
| MMCV | `turbo_physai/operators/{modulated_deform_conv,multi_scale_deformable_attn}.py`; `turbo_physai/optimizations/common/mmcv/msda.py` | <https://github.com/open-mmlab/mmcv> @ `ccdc61c0878d27ac7cccfecd7b474320817f0bbf` (v1.4.3) | `mmcv/ops/{modulated_deform_conv,multi_scale_deform_attn}.py` | Apache-2.0 | No `NOTICE` file identified at the fixed baseline. |
