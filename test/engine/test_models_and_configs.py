...
class ModelsAndConfigsTest(unittest.TestCase):
    ...
    def test_builtin_model_optimization_config_is_flattened_after_generation(self):
        ...
        self.assertEqual(common.extends, ())
        self.assertNotIn("commits", common.compatibility)
        self.assertEqual(
            [entry.id for entry in common.optimization_groups],
            [
                "mmcv.msda",
                "mmdet3d.gaussian",
                "mmdet3d.bev_pool",
        ...
        self.assertTrue(
            all(entry.trust for entry in common.optimization_groups)
        )
        self.assertEqual(bevformer.extends, ())
        self.assertEqual(
            [entry.id for entry in bevformer.optimization_groups],
            [
                "mmcv.msda",
                "bevformer.mdc",
                "bevformer.msda",
        ...
        self.assertEqual(
            bevformer.optimization_modules,
            (
